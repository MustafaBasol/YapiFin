    ...
    <div className="mx-auto max-w-[1100px] animate-fade-in space-y-6">
      <div>
        ...
        <p className="mt-0.5 text-sm text-muted-foreground">
          Tamamlanmış son haftanın finansal tablosu: tahsilat, ödeme ve kârlılık bir önceki haftayla karşılaştırılır; nakit ve
          bütçe durumu anlık olarak gösterilir. Rakamlar YapıFin&apos;in kendi hesaplamalarıdır; yorum, önceliklendirme ve aksiyon
          önerileri yapay zekâ tarafından üretilir.
        </p>
      </div>
