...
export default async function AskYapiFinPage() {
  ...
  return (
    <div className="mx-auto max-w-[1100px] animate-fade-in space-y-6">
      <div>
        <h1 className="font-display text-2xl font-bold tracking-tight">YapiFin&apos;e Sor</h1>
        <p className="mt-0.5 text-sm text-muted-foreground">
          Bütçe, nakit akışı, alacak/borç ve proje durumu hakkında sorular sorun. Rakamlar her zaman YapiFin&apos;in kendi
