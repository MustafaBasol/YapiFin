...
/** YF-813 — add-on Checkout iptal dönüşü. Hiçbir kota mutasyonu YAPMAZ (bkz. success/page.tsx aynı not). */
export default async function AddonCheckoutCancelPage() {
  await requireUser();
  ...
  return (
    <div className="mx-auto max-w-lg animate-fade-in space-y-4 py-12 text-center">
      ...
      <p className="text-sm text-muted-foreground">
        Ödeme adımından çıktınız, herhangi bir ücret alınmadı. Mevcut kotanız değişmedi. Dilediğiniz zaman tekrar
        deneyebilirsiniz.
      </p>
      <Link
